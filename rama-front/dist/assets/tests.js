...
define('rama-front/tests/helpers/ember-simple-auth', ['exports', 'ember-simple-auth/authenticators/test'], function (exports, _test) {
  'use strict';
...
define('rama-front/tests/unit/controllers/login-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('rama-front/tests/unit/models/user-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('rama-front/tests/unit/routes/login-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('rama-front/config/environment', [], function() {
          ...
          var exports = {
            'default': {"modulePrefix":"rama-front","environment":"test","rootURL":"/","locationType":"none","historySupportMiddleware":true,"apiURL":"http://localhost:3000/api","cdnURL":"http://localhost:3000","EmberENV":{"FEATURES":{},"EXTEND_PROTOTYPES":{"Date":false}},"APP":{"LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"rootElement":"#ember-testing","autoboot":false,"name":"rama-front","version":"0.0.0+31787cf1"},"ember-simple-auth-token":{"serverTokenEndpoint":"http://localhost:3000/api/user_token/","tokenPropertyName":"token","refreshTokenPropertyName":"token"},"emberData":{"enableRecordDataRFCBuild":false},"exportApplicationGlobal":true}
          };
