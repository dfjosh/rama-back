...
define('rama-front/tests/components/rama-pagination.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | components/rama-pagination.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/rama-pagination.js should pass jshint.');
  });
});
...
define('rama-front/tests/controllers/application.jshint', ['exports'], function (exports) {
  'use strict';
...
define('rama-front/tests/integration/components/rama-pagination-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('rama-pagination', 'Integration | Component | rama pagination', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'rama-pagination', ['loc', [null, [1, 0], [1, 19]]], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'rama-pagination', [], [], 0, null, ['loc', [null, [2, 4], [4, 24]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('rama-front/tests/integration/components/rama-pagination-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | integration/components/rama-pagination-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/rama-pagination-test.js should pass jshint.');
  });
});
...
define('rama-front/tests/routes/projects.jshint', ['exports'], function (exports) {
  'use strict';
...
define('rama-front/tests/unit/controllers/application-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('rama-front/tests/unit/controllers/application-test.jshint', ['exports'], function (exports) {
  'use strict';
...
define('rama-front/tests/unit/routes/projects-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('rama-front/tests/unit/routes/projects-test.jshint', ['exports'], function (exports) {
  'use strict';
